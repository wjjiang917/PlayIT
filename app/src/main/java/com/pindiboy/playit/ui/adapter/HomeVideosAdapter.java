...
public class HomeVideosAdapter extends BaseItemDraggableAdapter<Item<String>, BaseViewHolder> {
    public HomeVideosAdapter(List<Item<String>> data) {
        super(R.layout.item_video_home, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, Item<String> item) {
